...
void pravidla() {
  if(tisk == 1){
    ...
    if((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'J')||
       (umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'j')){
...
void planovac() {
  ...
  if (stav == ST_PRAVIDLA) {
      if (((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'J') && (((abs(kamX - odkudX) == 1) && (abs(kamY - odkudY) == 2))||((abs(kamX - odkudX) == 2) && (abs(kamY - odkudY) == 1))))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'j') && (((abs(kamX - odkudX) == 1) && (abs(kamY - odkudY) == 2))||((abs(kamX - odkudX) == 2) && (abs(kamY - odkudY) == 1))))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'V') && ((abs(kamX - odkudX) == 0)||(abs(kamY - odkudY) == 0)))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'v') && ((abs(kamX - odkudX) == 0)||(abs(kamY - odkudY) == 0)))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'S') && (abs(kamX - odkudX)) == (abs(kamY - odkudY)))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 's') && (abs(kamX - odkudX)) == (abs(kamY - odkudY)))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'K') && (((abs(kamX - odkudX) == 1) && (abs(kamY - odkudY) == 0))||((abs(kamX - odkudX) == 0) && (abs(kamY - odkudY) == 1))||((abs(kamX - odkudX) == 1) && (abs(kamY - odkudY) == 1))))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'k') && (((abs(kamX - odkudX) == 1) && (abs(kamY - odkudY) == 0))||((abs(kamX - odkudX) == 0) && (abs(kamY - odkudY) == 1))||((abs(kamX - odkudX) == 1) && (abs(kamY - odkudY) == 1))))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'D') && ((abs(kamX - odkudX) == 0)||(abs(kamY - odkudY) == 0)||((abs(kamX - odkudX)) == (abs(kamY - odkudY)))))|| 
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'd') && ((abs(kamX - odkudX) == 0)||(abs(kamY - odkudY) == 0)||((abs(kamX - odkudX)) == (abs(kamY - odkudY)))))|| 
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'P') && ((odkudX - '1') == (1)) && (abs(kamX - odkudX) <= 2) && (abs(kamY - odkudY) == 0))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'P') && ((odkudX - '1') != (1)) && (abs(kamX - odkudX) == 1) && ((kamY - odkudY) == 0))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'p') && ((odkudX - '1') == (6)) && (abs(kamX - odkudX) <= 2) && (abs(kamY - odkudY) == 0))||
          ((umistni_figurek[odkudX - '1'][odkudY - 'A'] == 'p') && ((odkudX - '1') != (6)) && (abs(kamX - odkudX) == 1) && ((kamY - odkudY) == 0))){
        tisk = 1;
        stav = ST_VYHAZOVANI;
           }
      else {
            ...
            stav = ST_CHYBNY_TAH; 
            tisk = 1;        
            //Serial.println (odkudX);
            //Serial.println (kamX-odkudX);
            //Serial.println (kamY-odkudY);
            }      
    }
  ...
  if (stav == ST_VYHAZOVANI) {
    if (tisk == 1){
      if (umistni_figurek[odkudX - '1'][odkudY - 'A'] == '0'){
        stav = ST_PRO_FIGURKU;
        tisk = 1;
      }
      else {
        if (tisk == 1) {
          Serial.println("Vyhozena figurka: ");
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'V'){
            Serial.println("Bila vez");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'v'){
            Serial.println("Cerna vez");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'J'){
            Serial.println("Bily jezdec");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'j'){
            Serial.println("Cerny jezdec");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'S'){
            Serial.println("Bily strelec");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 's'){
            Serial.println("Cerny strelec");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'D'){
            Serial.println("Bila dama");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'd'){
            Serial.println("Cerna dama");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'K'){
            Serial.println("Bily kral");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'k'){
            Serial.println("Cerny kral");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'P'){
            Serial.println("Bily pesec");
          }
          if(umistni_figurek[kamX - '1'][kamY - 'A'] == 'p'){
            Serial.println("Cerny pesec");
          }
          tisk = 0;
        }
        stav = ST_PRO_FIGURKU;
