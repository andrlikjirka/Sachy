...
void ulozeni_tahu_do_pameti() {
  pamet_tahu[pamet_tahu_index][0] = '0';
  pamet_tahu[pamet_tahu_index][1] = '0';
  pamet_tahu[pamet_tahu_index][2] = '0';
  pamet_tahu[pamet_tahu_index][3] = '0';
  
  pamet_tahu[pamet_tahu_index][0] = odkud_pismeno;
  pamet_tahu[pamet_tahu_index][1] = odkud_cislo;
  pamet_tahu[pamet_tahu_index][2] = kam_pismeno;
  pamet_tahu[pamet_tahu_index][3] = kam_cislo;
}
